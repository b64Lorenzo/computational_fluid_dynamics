...
% Test using Central Differencing
% =========================================================================
...
logger(fid,'INFO','Scheme = Central');
...
[phi,A,rhs] = convection_diffusion_1d(mesh,U,k,bc,@central_scheme_1d,fid);
...
title('1D Convection-Diffusion (Central Scheme)');
...
saveas(gcf,fullfile(figures_dir,'central_solution.png'));

logger(fid,'INFO','Figure saved');

%% Save solution

save(fullfile(data_dir,'central_solution.mat'),'mesh','phi','A','rhs');

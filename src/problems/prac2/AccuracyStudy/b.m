...
% Produces:
%
%   1) One figure with all numerical solutions
%      and their analytical reference solutions
%
%   2) One figure with all eigenvalue spectra
%
% =========================================================================
...
problem_name = 'methodA_accuracy_eigenvalues';

fid = logger_init(problem_name);

logger(fid,'INFO',...
    'Starting Method A study');
...
all_eigs = cell(length(ratio_list),1);
...
xlim([0.8,1.05])
title('Method A: Numerical vs Analytical Solution');
...
saveas( ...
    ...
    fullfile( ...
    figures_dir,...
    'methodA_solution_comparison.png'));
...
title('Method A Eigenvalue Spectra');
...
saveas( ...
    ...
    fullfile( ...
    figures_dir,...
    'methodA_eigenvalue_comparison.png'));
